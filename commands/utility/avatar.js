  ...
  async execute(client, message, args, ee) {
    try {
      ...
      message.reply({ embeds:[new MessageEmbed()
        ...
        .addField("<a:ag_ARROW:959084917071937607> PNG",`[\`LINK\`](${member.displayAvatarURL({format: "png"})})`, true)
        .addField("<a:ag_ARROW:959084917071937607> JPEG",`[\`LINK\`](${member.displayAvatarURL({format: "jpg"})})`, true)
        .addField("<a:ag_ARROW:959084917071937607> WEBP",`[\`LINK\`](${member.displayAvatarURL({format: "webp"})})`, true)
        .setColor(ee.color)
