    ...
    client.on("guildMemberRemove", async (member) => {
      ...
      try {
        ...
        Schema2.findOne({
          ...
          await channel.send({ content: `<a:nca_panda_cry:959088347828093019> Look like **${member.user.tag}** just left the server <:Bye_1:959088302898708520>`, files: [attachment] }).catch(err => console.log('I was unable to send goodbye image.'));
